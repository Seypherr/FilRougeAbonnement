...
- The reminder sender script is ready via `npm run reminders:send --workspace backend`. The free Render pre-production blueprint does not include the paid Render cron job.
