          ...
          <>
            <section className="rounded-[24px] border border-slate-100 bg-white p-5 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.04)] lg:p-6">
              ...
              <form className="grid gap-4 lg:grid-cols-[1.1fr_1.2fr_1fr_150px_130px]" onSubmit={createUser}>
                ...
                <input aria-label={t.password} value={newUser.password} autoComplete="new-password" onChange={(event) => setNewUser({ ...newUser, password: event.target.value })} placeholder={t.password} type="password" className="w-full rounded-xl border border-slate-200 bg-[#F8F9FB] px-4 py-3 text-sm font-medium transition-all placeholder:font-normal focus:border-[#6C51FF] focus:outline-none focus:ring-1 focus:ring-[#6C51FF]" required minLength={8} disabled={creating} />
