...
export function AnalyticsPage({ t, subscriptions, totalMonthlyAmount, loading, error, setTab }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#F8F9FB] p-6 lg:min-h-0 lg:bg-transparent">
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#F8F9FB] pb-32 text-slate-900 lg:min-h-0 lg:rounded-[32px] lg:bg-transparent lg:pb-8">
      ...
      <div className="hidden lg:block">
        ...
        <section className="mt-6 grid gap-4 md:grid-cols-3">
          <div className="rounded-[20px] bg-white p-5 shadow-[0_4px_24px_-12px_rgba(0,0,0,0.08)]">
            ...
            <p className="mt-2 text-2xl font-bold text-slate-900">{formatMoney(totalMonthlyAmount)}</p>
          </div>
          <div className="rounded-[20px] bg-white p-5 shadow-[0_4px_24px_-12px_rgba(0,0,0,0.08)]">
      ...
      <section className="relative z-10 mb-8 px-6 lg:mt-8 lg:px-0">
        <h2 className="mb-4 px-1 text-[17px] font-bold text-slate-800">{t.categories}</h2>
